...
{
    internal class _08_mod_mandar_mensajes
    {
        ...
        public string operacion_a_hacer(string info)
        {
            ...
            if (proceso == "MANDAR_MENSAJE_WATSAP")
            {
                // Caso específico para un proceso llamado "CREAR_ARCHIVO"
                _08_proc_mandar_mensajes proc_mandar_mensajes = new _08_proc_mandar_mensajes();
                info_a_retornar = EjecutarFuncionEnDatos(proc_mandar_mensajes.mandar_mensaje_watsap, datos);
            }
