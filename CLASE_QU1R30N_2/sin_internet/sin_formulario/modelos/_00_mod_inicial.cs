...
{
    internal class _00_mod_inicial
    {
        ...
        // Instancia de la clase `_00_proc_inicial` para acceder a sus funciones o metodos
        _00_proc_inicial pro_inicial = new _00_proc_inicial();
