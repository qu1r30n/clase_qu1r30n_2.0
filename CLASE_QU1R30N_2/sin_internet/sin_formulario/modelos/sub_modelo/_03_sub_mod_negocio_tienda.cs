...
{
    internal class _03_sub_mod_negocio_tienda
    {
        ...
        public string operacion_a_hacer(string info)
        {
            ...
            string[] datos_spliteados = info.Split(G_caracter_separacion_funciones_espesificas[2][0]);
