...
{
    internal class _03_proc_negocios
    {
        ...
        public string ventas(string datos)
        {
            string info_a_retornar = null;
            ...
            // PARAMETROS ---------------------------------------------------------------------------
            string codigos = datos_epliteados[0];
            ...
            string[] id = IDS.Split(G_caracter_separacion[1][0]);
            ...
            for (int i = 0; i < id.Length; i++)
            {
                ...
                {
                    //falta buscar el codigo de barras para encontrar el id y modificarlo y si no se encuentra mandar error
                }
